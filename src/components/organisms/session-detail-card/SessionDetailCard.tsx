...
const SessionDetailCard: FC<SessionDetailCardProps> = ({ session: s, allProjects }) => (
  ...
  >
    ...
    <div className='flex items-center gap-2 flex-wrap'>
      ...
      <span className='ml-auto inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full border bg-gray-light-200 dark:bg-gray-dark-700 border-gray-light-400 dark:border-gray-dark-400 text-gray-light-600 dark:text-gray-dark-300 shrink-0'>
        <Layers size={9} />
    ...
    {/* Row 4: topic_key */}
    {s.topicKey && (
      <p className='inline-flex items-center gap-1 text-[11px] text-gray-light-500 dark:text-gray-dark-300'>
    ...
    {/* Row 5: session id */}
    <p className='text-[10px] text-gray-light-400 dark:text-gray-dark-300 truncate'>{s.sessionId}</p>
  </div>
);
